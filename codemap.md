...
| `packages/cli/src/`                                                    | CLI tool: 5 commands (daemon, status, adapters, workspaces, doctor), file-lock ownership, 8-check health engine, structured JSON output, `--dashboard` flag for local dashboard surface (ADR-0035)              | [codemap.md](packages/cli/src/codemap.md)                                                    |
